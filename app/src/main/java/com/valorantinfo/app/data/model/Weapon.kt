...
data class Weapon(
    ...
    @SerializedName("skins") val skins: List<WeaponSkin>?
)
...
data class WeaponStats(
    ...
    @SerializedName("altShotgunStats") val altShotgunStats: AltShotgunStats?,
    @SerializedName("airBurstStats") val airBurstStats: AirBurstStats?,
...
data class AltShotgunStats(
    @SerializedName("shotgunPelletCount") val shotgunPelletCount: Int,
    @SerializedName("burstRate") val burstRate: Double
)

data class AirBurstStats(
    @SerializedName("shotgunPelletCount") val shotgunPelletCount: Int,
    @SerializedName("burstDistance") val burstDistance: Double
)
